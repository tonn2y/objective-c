...
{
    //这里使用拷贝方式，添加卡片
    AddressCard *temp = [[AddressCard alloc]init];
    
    temp.name = [NSString stringWithString:theCard.name];
    temp.email = [NSString stringWithString:theCard.email];
    temp.address = [NSString stringWithString:theCard.address];
    temp.city = [NSString stringWithString:theCard.city];
    temp.country = [NSString stringWithString:theCard.country];
    temp.phoneNumber = [NSString stringWithString:theCard.phoneNumber];
